...
; and The Nasty Hackers' Repeater Consortium.
; All Rights Reserved.
;*******************************************************************************
...
Main10
	movlw	EECT1		; get eeprom address of CT mask
	btfsc	mscFlag,RBTXENA	; is rb tx enabled?
	movlw	EECT12		; yes, get that courtesy tone
	btfss	mscFlag,RBALERT	; is rb alert enabled
	goto	Main10h		; no; continue
	btfss	tFlags,TRBCOR	; is rb squelch open? (negative logic)
        movlw   EECT1A		; yes, get that courtesy tone

Main10h
	call	ReadEE		; get the courtesy tone mask.
...
RbRx1Off			; receiver was active, became inactive
	...
	movlw	EECT2		; get eeprom address CT mask
	btfss	mscFlag,RBTXENA	; is rb tx enabled?
	goto	RbRx1oc		; no, set the tone & hang
	movlw	EECT22		; yes, get that courtesy tone
