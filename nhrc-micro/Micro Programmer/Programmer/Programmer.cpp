...
const LPSTR controlGroupNames[] = {"Group 0 - Repeater Access Control",
                                   "Group 1 - Repeater Timer Control",
                                   "Group 2 - Courtesy Tones and Muting",
                                   "Group 3 - IDer Control",
                                   "Group 4 - Reserved",
                                   "Group 5 - Reserved",
                                   "Group 6 - Reserved",
                                   "Group 7 - Reserved",
...
const LPSTR controlItemNames[] = { "Repeater Enable",                 // 0.0
                                   "COR and CTCSS",                   // 0.1
                                   "COR or CTCSS",                    // 0.2
                                   "COR and CTCSS when Idle",         // 0.3
                                   "DTMF access mode",                // 0.4
                                   "Reserved",                        // 0.5
                                   "Reserved",                        // 0.6
                                   "Reserved",                        // 0.7
                                   
                                   "Hang Timer Enable",               // 1.0
                                   "Long Hang Timer Select",          // 1.1
                                   "Time Out Timer Enable",           // 1.2
                                   "Long Time Out Timer Select",      // 1.3
                                   "Reserved",                        // 1.4
                                   "Reserved",                        // 1.5
                                   "Reserved",                        // 1.6
                                   "Key Up Delay Enable",             // 1.7

                                   "Courtesy Tone Enable",            // 2.0
                                   "DTMF Muting Enable",              // 2.1
                                   "Select Courtesy Tone #1",         // 2.2
                                   "Select Courtesy Tone #2",         // 2.3
                                   "Select Courtesy Tone #3",         // 2.4
                                   "Select Courtesy Tone #4",         // 2.5
                                   "Select Courtesy Tone #5",         // 2.6
                                   "Select Courtesy Tone #6",         // 2.7
                                   
                                   "Immediate ID Mode",               // 3.0
                                   "Beacon Mode",                     // 3.1
                                   "IDer Mode",                       // 3.2
                                   "CW Key on PTT",                   // 3.3
                                   "Reserved",                        // 3.4
                     ...
                     int       nCmdShow)
{
    ...
    strncpy_s(filter, FILTER_LENGTH, "NHRC-Micro Controller Data (*.bin)|*.bin|", _TRUNCATE);
    ...
    if (!hPrevInstance)
    {
        ...
        wcex.lpszClassName	= "MICRO-PROGRAMMER";
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    hWnd = CreateWindow("MICRO-PROGRAMMER",         // class name
		                "NHRC-Micro Programmer", // Window Titlt
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message) 
    {
		...
		case ID_FILE_SELECT_COMPORT:
                    if (DialogBox(hInst, (LPCTSTR)IDD_SELECT_COMPORT, hWnd, 
                        (DLGPROC)SelectComportDialogBoxProc) == -1)
                    {
        ...
        case WM_PAINT:
			...
			strncpy_s(text, TEXT_LENGTH,
				...
				"2. Edit Data.\n"
				"3. Save data to controller and/or file", _TRUNCATE);
...
void SetWindowTitle(HWND hwnd, LPSTR name)
{
    ...
    if (name[0] != 0 )
    {
        wsprintf(message, "NHRC-Micro Programmer - %s %s", rawFileName, unsaved ? "(unsaved)" : "");
    } // if (filename[0] != 0) 
    else
    {
        wsprintf(message, "NHRC-Micro Programmer %s", unsaved ? "(unsaved)" : "");
    } // if (filename[0] != 0) 
