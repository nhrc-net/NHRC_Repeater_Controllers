...
; Copyright (C) 1998, 1999 Jeffrey B. Otterson and NHRC LLC.
; All Rights Reserved.
;*******************************************************************************
...
;variables
	...
	tenCnt			; ten second count
        pCtrl                   ; port control flag
        pMode                   ; port mode flag
	pDelay			; port delay counter
...
MsgCmd				; 4x, 5x, 6x, 7x commands
	...
	movlw   h'01'		; this value must equal address' high byte
