...
<html> <head>
<title>NHRC-3 Programming Information Generator</title>
...
function convert()
{
    ...
    { /* check ISD size bits */
        if (document.nhrc3params.cboISD[0].checked)
            eeprom[CONFIG_ADDR] |= 0x0C
        if (document.nhrc3params.cboISD[2].checked)
            eeprom[CONFIG_ADDR] |= 0x04
        if (document.nhrc3params.cboISD[3].checked)
...
<FONT SIZE=4 color=red><B>Firmware Version 4.3 Only!</B></FONT><br>
</div>
...
<table>
  ...
  <tr>
    <td align=right>ISD1000</td>
    <td><input type="RADIO" name="cboISD" value="1000"></td>
  </tr>
  <tr>
    <td align=right>ISD1420</td>
    <td><input type="RADIO" name="cboISD" value="1420"></td>
  </tr>
  <tr>
    <td align=right>ISD2560</td>
    <td><input type="RADIO" name="cboISD" value="2560"></td>
  </tr>
  <tr>
    <td align=right>ISD2590</td>
    <td><input type="RADIO" name="cboISD" value="2590" CHECKED></td>
  </tr>
  <tr>
